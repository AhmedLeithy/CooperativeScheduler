...
void printTask1(){
	...
	addDelayedTask(&delayedQueue, printTask1, 2,5);
}
void printTask2(){
	uint8_t task2[] = "I am Task 2!!\n";
	sendUART(task2, sizeof(task2));
	
	addDelayedTask(&delayedQueue, printTask2, 2,6);
}
void printTask3(){
	uint8_t task3[] = "I am Task 3!!\n";
	sendUART(task3, sizeof(task3));
	
	addDelayedTask(&delayedQueue, printTask3, 2,0);

}
void printTask4(){
	uint8_t task4[] = "I am Task 4!!\n";
	sendUART(task4, sizeof(task4));
	addDelayedTask(&delayedQueue, printTask4, 2,3);
}
